/**
 * Migration 003 — sign-in artefacts follow their app and user.
 *
 ...
 */
export const MIGRATION_003_CASCADE_SIGN_IN_ARTEFACTS = `
CREATE TABLE authorization_codes_v3 (
...
INSERT INTO authorization_codes_v3
...
ALTER TABLE authorization_codes_v3 RENAME TO authorization_codes;
CREATE INDEX idx_authorization_codes_expires ON authorization_codes(expires_at);

CREATE TABLE refresh_tokens_v3 (
...
ALTER TABLE refresh_tokens_v3 RENAME TO refresh_tokens;
CREATE INDEX idx_refresh_tokens_app_user ON refresh_tokens(app_id, user_id);

CREATE TABLE device_codes_v3 (
...
ALTER TABLE device_codes_v3 RENAME TO device_codes;
`;
